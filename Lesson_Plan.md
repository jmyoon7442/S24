...
|-------|-----------------------------------------------------|--------------------------------------------------------------------------------------|
| 5 min | Preview                                             | Watch a short video related to the story and discuss a key question                  |
| 20 min| Learning the Story                                  | Use Read-Aloud Practice App for sentence-by-sentence reading and pronunciation       |
| 5 min | Grammar Teaching                                    | Explain relative pronouns using slide images                                         |
| 6 min | Personal Activity for Grammar Learning              | Create and share sentences using the Sentence Combiner App                           |
| 5 min | Group Activity for Story Comprehension              | Use the Multiple Question App for group comprehension questions                      |
| 3 min | Feedback on Group Activity                          | Provide feedback on the group activity                                               |
| 3 min | Review through Word Cloud App                       | Review key points using a word cloud                                                 |
| 2 min | Giving Assignment                                   | Assign homework using the Cloze Question App                                         |
